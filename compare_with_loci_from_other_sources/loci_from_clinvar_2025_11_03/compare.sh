...
for catalog in TRExplorer_v2:../../results__2026-02-01/1_to_1000bp_motifs/TRExplorer.repeat_catalog_v2.hg38.1_to_1000bp_motifs.bed.gz ; do
    echo ================================================================================================
    echo Comparing clinvar to ${catalog}
    echo ================================================================================================
    set -ex
    python3 ../compare_loci_with_catalog.py  --print-stats 2 --catalog ${catalog}   clinvar_TRs:${clinvar_bed}
    set +ex
    echo
done
