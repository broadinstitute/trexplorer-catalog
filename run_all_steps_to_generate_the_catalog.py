...
parser.add_argument("--hprc100-annotations", default="gs://tandem-repeat-catalog/v1.0/hprc_lps.2025_05.grouped_by_locus_and_motif.with_biallelic_histogram.tsv.gz",
