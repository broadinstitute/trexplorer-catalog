...
parser.add_argument("--tenk10k-annotations", default="gs://tandem-repeat-catalog/v1.1/tenk10k_str_mt_rows.reformatted.tsv.gz",
...
parser.add_argument("--hprc100-annotations", default="gs://tandem-repeat-catalog/v1.1/hprc_lps.2025_05.grouped_by_locus_and_motif.with_biallelic_histogram.tsv.gz",
                    help="Path of the HPRC100 annotations table generated by Egor Dolzhenko by running TRGT on 100 diverse PacBio 1kGP samples from the HPRC")
parser.add_argument("--skip-hprc100-annotations", action="store_true",
                    help="Skip adding HPRC100 annotations to the catalog")
parser.add_argument("--aou1027-annotations", default="gs://tandem-repeat-catalog/v1.1/AoULR_phase1_TRGT_Weisburd_v1.0.1_combined.txt.gz",
...
parser.add_argument("--variation-clusters-bed", default="gs://tandem-repeat-catalog/v1.0.2/TRExplorer.variation_clusters_and_isolated_TRs_v1.0.2.hg38.TRGT.bed.gz",
...
for key in "hg38_reference_fasta", "gencode_gtf", "variation_clusters_bed", "aou1027_annotations", "hprc100_annotations", "tenk10k_annotations":
    if (key == "aou1027_annotations" and args.skip_aou1027_annotations
        ...
        ) or (key == "hprc100_annotations" and args.skip_hprc100_annotations
...
core_columns = [
    ...
    #'AlleleFrequenciesFromHPRC100', 'StdevFromHPRC100',
